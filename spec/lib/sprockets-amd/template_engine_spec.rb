...
describe AMDTemplateEngine do
  ...
  it "extract module name" do
    ...
    expect(AMDTemplateEngine.new(file_fun).extract_module_name).to eq("App.WindowHeightAdjustable")
  end
  ...
  it "renders ready code" do
    ...
    expect(processed_file_fun).to eql AMDTemplateEngine.new(file_fun).render
  end
